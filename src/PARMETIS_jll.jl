...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import PARMETIS_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("b247a4be-ddc1-5759-8008-7e02fe3dbdaa"))
platforms = [Pkg.Artifacts.unpack_platform(e, "PARMETIS", artifacts_toml) for e in artifacts["PARMETIS"]]
...
if best_platform === nothing
    @debug("Unable to load PARMETIS; unsupported platform $(triplet(platform_key_abi()))")
else
