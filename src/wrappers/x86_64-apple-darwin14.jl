# Autogenerated wrapper script for PARMETIS_jll for x86_64-apple-darwin14
export libparmetis
...
const libparmetis_splitpath = ["lib", "libparmetis.dylib"]
...
const libparmetis = "@rpath/libparmetis.dylib"
